...
class BankAccount:
    ...
    def get_balance(self):
        """查询余额方法"""
        return f"{self.account_holder}的账户余额：{self.balance}元"
...
try:
    ...
    # 操作第一个账户
    print(account1.deposit(200))   # 存款200元
    print(account1.withdraw(150))  # 取款150元
    print(account1.get_balance())  # 查询余额
    
    # 操作第二个账户
    print(account2.deposit(300))   # 存款300元
    print(account2.withdraw(1000)) # 尝试取款1000元（会失败）
    print(account2.get_balance())  # 查询余额
