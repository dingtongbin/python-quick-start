...
# 测试安全除法函数
print(safe_divide(10, 2))  # 正常情况：输出 5.0
print(safe_divide(10, 0))  # 异常情况：输出错误信息
...
def process_user_input(user_input):
    ...
    try:
        ...
        # 捕获除零错误
        return "错误：输入不能为5（会导致除零）！"

# 测试用户输入处理
print(process_user_input("10"))   # 正常情况
print(process_user_input("abc"))  # 值错误情况
print(process_user_input("5"))    # 除零错误情况
...
# 测试风险操作
print(risky_operation([1, 2, 3]))    # 正常情况
print(risky_operation(""))           # 零除错误
print(risky_operation(None))         # 类型错误
```
